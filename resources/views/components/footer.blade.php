        ...
        <div class="relative z-10 max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-4 gap-12">
            ...
            <div>
                <h4 class="hp-title text-amber-200 mb-4">
                    <span data-vi="Về Always Café" data-en="About Always Café"></span>
                </h4>
                <p class="text-sm text-stone-400/80 leading-relaxed">
                    <span data-vi="Không gian chủ đề Harry Potter giữa lòng Hà Nội, nơi phép thuật gặp gỡ công nghệ hiện đại.
                    Mỗi góc nhỏ đều được thiết kế tinh tế theo phong cách — tối giản, ấm áp, và giàu cảm xúc." data-en="Harry Potter themed space in the heart of Hanoi, where magic meets modern technology.
                    Every corner is meticulously designed in a style — minimalist, warm, and emotionally rich."></span>
                </p>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm">
                    ...
                    <li class="flex items-center gap-2">
                        ...
                        <span data-vi="Thứ Hai - Chủ Nhật: 08:00 - 22:00" data-en="Monday - Sunday: 08:00 AM - 10:00 PM"></span>
                    </li>
                </ul>
            ...
            {{-- === Feedback Form === --}}
            <div>
                <h4 class="hp-title text-amber-200 mb-4"><span data-vi="Gửi phản hồi" data-en="Send Feedback"></span></h4>
                <form x-data="{ rating: 5 }" class="flex flex-col gap-3" action="{{ route('user.feedback.store') }}"
                  ...
                  focus:ring-2 focus:ring-amber-400/60 focus:outline-none transition" />
                    ...
                    <div class="flex items-center gap-2 pt-1">
                        ...
                        @endfor
                        <span class="text-xs text-stone-400/70 ml-2"><span data-vi="(Đánh giá)" data-en="(Rating)"></span></span>
                    </div>
