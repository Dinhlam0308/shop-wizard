<x-app-layout>
    ...
    <div>
        ...
        <section class="relative overflow-hidden min-h-[calc(100vh-4rem)] flex items-center">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="space-y-8">
                        {{-- Status badge --}}
                        <div class="inline-flex items-center gap-3 rounded-full hp-card px-4 py-2 hp-hover">
                            <div class="flex items-center gap-2">
                                <span
                                    class="h-2 w-2 rounded-full bg-gradient-to-r from-amber-400 to-yellow-500 animate-pulse"></span>
                                <span class="h-1 w-1 rounded-full bg-amber-300/60"></span>
                                <span class="h-1.5 w-1.5 rounded-full bg-amber-400/40"></span>
                            </div>
                            <span class="hp-caption text-amber-200/90">
                                <span data-vi="Phép Thuật × Công Nghệ • Trải Nghiệm Đỉnh Cao • Hà Nội"
                                    data-en="Magic × Technology • Premium Experience • Hanoi"></span>
                            </span>
                        </div>

                        {{-- Main headline --}}
                        <div class="space-y-4">
                            <h2 class="hp-title hp-display font-bold tracking-tight text-amber-50">
                                <span data-vi="Chào mừng đến với" data-en="Welcome to"></span>
                                <span
        ...
        {{-- ===== FULLWIDTH PROMO SECTION (Accessories / Gift / Wands...) ===== --}}
                    ...
                    <div class="relative z-10 px-6 py-10 md:px-10 md:py-14">
                        <div class="max-w-2xl space-y-4">
                            <p class="inline-flex items-center gap-2 text-xs md:text-sm text-amber-200/90">
                                ...
                                <span data-vi="Ưu đãi & Trải nghiệm mới"
                                    data-en="Special Offers & Experiences"></span>
                            </p>
        ...
        {{-- ===== EXPERIENCE / BOOKING GRID (Potion / Tarot / Workshop) ===== --}}
        <section class="mt-14 md:mt-16">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <a href="{{ route('user.booking.tarot') }}"
                            ...
                            <div class="relative z-10 w-full p-6 md:p-7">
                                <div
                                    class="inline-flex items-center gap-2 rounded-full px-3 py-1 text-xs font-medium
                                   bg-white/10 border border-white/15 text-amber-100 backdrop-blur-md">
                                    <span class="h-2 w-2 rounded-full bg-purple-300/80"></span>
                                    Tarot
                                </div>
...
group-hover:shadow-[0_30px_70px_rgba(0,0,0,0.55)]">
        ...
        {{-- ===== PROMO SECTION #2 (Accessories / Gift / Wands...) ===== --}}
        <section class="mt-14 md:mt-16">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {{-- Put this inside your existing <style> block (same file) --}}
        <style>
        ...
        window.addEventListener('load', () => {
            ...
            const createStars = () => {
                ...
                stars = Array.from({
                    ...
                    dx: (Math.random() - 0.5) * 0.08 * dpr,
                    dy: (Math.random() - 0.5) * 0.08 * dpr,
                    alpha: 0.3 + Math.random() * 0.5,
                    twinkle: Math.random() * 0.02 + 0.001,
            ...
            const animate = (timestamp) => {
                ...
                stars.forEach((star, i) => {
                    ...
                    const twinkle = Math.sin(timestamp * star.twinkle + star.twinkleOffset) * 0.3 + 0.7;
                    const currentAlpha = star.alpha * twinkle;

                    const hue = 45 + Math.sin(timestamp * 0.001 + i * 0.1) * 15;
                    ctx.fillStyle = `hsla(${hue}, 70%, 85%, ${currentAlpha})`;
