    ...
    <x-slot name="header">
        ...
        <header class="text-center mb-12 space-y-3">
            ...
            <p class="mt-4 text-gray-300 max-w-2xl mx-auto text-lg leading-relaxed">
                <span data-vi="Không gian nơi cảm hứng gặp gỡ phép màu." data-en="A space where inspiration meets magic."></span>
            </p>
        </header>
    </x-slot>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            @empty
                <div class="col-span-full text-center text-gray-400">
                    <span data-vi="Hiện chưa có workshop nào sắp diễn ra ✨" data-en="No upcoming workshops available ✨"></span>
                </div>
            @endforelse
        </div>
