            ...
            <div class="relative isolate group max-w-2xl mx-auto w-full">
                ...
                <form action="{{ route('user.booking.store') }}" method="POST"
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <select name="type" required
                                    ...
                                    <option value="" class="text-gray-400"><span data-vi="-- Chọn loại --"
                                            data-en="-- Select Type --"></option>
                                    <option value="table"><span data-vi="Bàn cà phê" data-en="Coffee Table"></option>
                                    <option value="potion_class"><span data-vi="Lớp học Potion" data-en="Potion Class">
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        {{-- People --}}
                        <div class="space-y-2">
                            <label for="people_count" class="text-sm font-medium text-gray-200"><span data-vi="Số người"
                                    data-en="Number of People"></span></label>
                            <div class="relative">
                                <i data-lucide="users"
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea name="note" id="note" rows="4"
                                ...
                                data-placeholder-vi="Ví dụ: muốn chỗ yên tĩnh, ngồi gần cửa sổ, v.v..." data-placeholder-en="Example: want a quiet spot, sit near the window, etc..."></textarea>
                        </div>
                    </div>
