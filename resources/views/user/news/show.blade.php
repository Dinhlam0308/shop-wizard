        ...
        <div class="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="py-10">
                ...
                <div class="grid gap-6 sm:grid-cols-2">
                    @foreach (\App\Models\News::where('id', '!=', $news->id)->latest()->take(2)->get() as $related)
                        <a href="{{ route('user.news.show', $related->id) }}"
                            ...
                            <div class="flex items-center gap-4">
                                <div class="w-20 h-20 rounded-xl overflow-hidden flex-shrink-0">
                                    <x-fallback-image src="{{ $related->image ?? '/images/fallback-news.jpg' }}"
                                        alt="{{ $related->title }}"
