<x-app-layout>
    ...
    <section class="relative">
        {{-- Glow orbs --}}
        <div class="pointer-events-none absolute -top-40 right-0 w-[520px] h-[520px] rounded-full bg-amber-400/10 blur-3xl"></div>
        <div class="pointer-events-none absolute -bottom-20 left-0 w-[520px] h-[520px] rounded-full bg-purple-500/10 blur-3xl"></div>
                ...
                <div class="grid md:grid-cols-2 gap-6 p-6 md:p-10">
                    <div class="space-y-3">
                        ...
                        <h2 class="text-3xl md:text-4xl font-semibold text-amber-100 leading-tight">
                            <span data-vi="Bản Tin Phép Thuật — Sự kiện, ưu đãi và câu chuyện hậu trường" data-en="Magical News — Events, Offers and Behind-the-Scenes Stories"></span>
                        </h2>
                        <p class="text-stone-300/85">
                            <span data-vi="Cập nhật mới nhất từ thế giới Always Café: workshop, menu mùa vụ, ưu đãi theo nhà và các câu chuyện “magic” phía sau quầy bar." data-en="Latest updates from the Always Café world: workshops, seasonal menus, special offers and behind-the-scenes stories."></span>
                        </p>
                    ...
                    <div class="relative rounded-2xl overflow-hidden">
                        <div class="absolute inset-0 bg-gradient-to-tr from-amber-500/10 via-transparent to-purple-500/10"></div>
                        <x-fallback-image
                            src="/images/hero-hogwarts.jpg"
                            alt="Always Café News" />
                    </div>
                </div>
            </div>
            ...
            <div class="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                @forelse ($news as $item)
                    <article
                        ...
                        <div class="relative aspect-[16/10] overflow-hidden">
                            <x-fallback-image
                                src="{{ $item->image ?? '/images/fallback-news.jpg' }}"
                                alt="{{ $item->title }}"
                        ...
                        <div class="p-5 flex flex-col h-full">
                            ...
                            <div class="mt-4 flex items-center justify-between">
                                ...
                                <div class="flex items-center gap-3 text-amber-200/80">
                                    <button class="hover:text-amber-100 transition" title="Copy link"
                                            x-data
                ...
                @empty
                    <div
                        ...
                        <p class="mt-3 text-amber-100 font-medium"><span data-vi="Chưa có bài viết nào." data-en="No articles available."></span></p>
                        <p class="text-stone-400/80 text-sm"><span data-vi="Hãy quay lại sau để khám phá thế giới phép thuật mới!" data-en="Come back later to discover the magical world!"></span></p>
                    </div>
                @endforelse
            </div>
    ...
    <style>
        .hp-card { will-change: transform, box-shadow, filter; }
        .hp-caption { font-size: 12px; letter-spacing: .02em; }
