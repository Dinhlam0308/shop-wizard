                            ...
                            <div x-cloak x-show="showRemoveConfirm"
                                ...
                                <div id="askRemoveConfirmModal"
                                    ...
                                    <p class="text-stone-400/80 text-sm mb-5">
                                        <span data-vi="Bạn có chắc muốn xóa" data-en="Are you sure you want to remove"></span>
                        ...
                        <template x-teleport="body">
                            <div x-cloak x-show="showClearConfirm"
                                ...
                                <div id="askClearConfirmModal"
                                    ...
                                    <h3 class="text-red-200 text-xl font-semibold mb-2"><span data-vi="Xóa toàn bộ giỏ hàng?" data-en="Clear entire cart?"></span></h3>
                                    <p class="text-stone-400/80 text-sm mb-5">
                                        <span data-vi="Hành động này sẽ xóa tất cả sản phẩm trong giỏ hàng. Bạn chắc chứ?" data-en="This action will remove all products in the cart. Are you sure?"></span>
                                    </p>
