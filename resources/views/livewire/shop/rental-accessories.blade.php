    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 hp-card rounded-3xl p-8">
            <div class="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p class="text-stone-300/70 text-sm"><span data-vi="Trang phục cosplay chất lượng cao" data-en="High-quality cosplay costumes"></span></p>
                </div>
        ...
        <div
            ...
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h3 class="hp-title hp-headline text-amber-200 mb-2"><span data-vi="Phụ Kiện Nổi Bật" data-en="Featured Accessories"></span></h3>
                    <p class="text-stone-300/70 text-sm"><span data-vi="Phụ kiện phép thuật chính hãng" data-en="Authentic magical accessories"></span></p>
                </div>
